...
\begin{enumerate}
	\item Bagaimana rancangan \textit{basic gameplay} untuk \textit{game first person shooter}(fps) ?
	\item Bagaimana rancangan fitur sinkronisasi \textit{multiplayer} online secara \textit{realtime} dengan menggunakan Photon Unity Networking dan data apa saja yang perlu disinkronisasi?
