...
\bibitem{guilag}
Photon Lag Simulation Gui," Photon, [Online]. Available : https://doc.photonengine.com/pun/current/troubleshooting/photon-lag-simulation-gui [Accessed 15 Maret 2023].
...
\bibitem{wireshark}
Irawan, D., 2017. \emph{ANALISIS DAN PENYADAPAN TRANSMISI PAKET DATA 
JARINGAN KOMPUTER MENGGUNAKAN WIRESHARK}. MIKROTIK: Jurnal Manajemen Informatika, 7(1).
\bibitem{Gebug}
...
\bibitem{qos}
Imansyah, F., Kusumawardhani, E. and Yacoub, R.R., \emph{ANALISIS QUALITY OF SERVICE (QoS) PADA JARINGAN INDIHOME KOTA KETAPANG.} Jurnal Teknik Elektro Universitas Tanjungpura, 2(1).
\bibitem{gogreen}
