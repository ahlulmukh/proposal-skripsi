...
Teknik pengujian ini untuk mengetahui algoritma yang telah dirancang apakah berjalan dengan lancar atau tidak.
...
Teknik pengujian performa untuk melakukan pengujian server pada photon cloud menggunakan wireshark untuk mengukur troughput, delay dan packet loss.
\section{Hasil yang diharapkan}
Hasil yang diharapkan pada penilitian ini antara lain :
\begin{enumerate}
    \item Keberhasilan dalam mengetahui kelayakan aplikasi \textit{game} dengan metode \textit{blackbox testing}, whitebox, pengujian performa dan pengujian delay.
