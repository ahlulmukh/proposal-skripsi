...
\subsection{Rancangan \textit{Class Diagram}}
\begin{figure}[h]
   \centering
...
CreateObjectP merupakan kelas yang berfungsi untuk membuat map atau game object yang diinisialisasi.
...
GameplayMultiP merupakan class yang berfungsi sebagai \textit{gameplay} yang akan dimainkan seperti player, point pada game dan respawn pemain saat mati.
